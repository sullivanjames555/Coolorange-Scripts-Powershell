...
#########  SCRIPT VARIABLES
$csvFileLocation = "C:\temp\test-vault orphans.csv"
$outputFileName = "C:\Temp\Deleted_Orphans$(Get-Date -Format "yyyyMMdd-hhmmss")_Log" 

####### File prefixes to delete

$90dayDeletePrefixes = "325","5500"
$90dayDeletePrefixes += "800"
$90dayDeletePrefixes += "801"
$90dayDeletePrefixes += "803"
...
$120dayDeletePrefixes = "907-4-","930-4-"
