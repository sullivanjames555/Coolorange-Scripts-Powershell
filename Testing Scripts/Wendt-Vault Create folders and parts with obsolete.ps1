...
$file2 = add-vaultfile -from $partpath -to "$/$conveyorname/D85xx - Guards/$conveyors-4-D85xx - Guards-dummy-A0.ipt" -force $true
...
$obsoleteconnew1 = $vault.DocumentService.AddFolder($obsolete, $conroot.Id,$false)
$conroot2 = $vault.DocumentService.AddFolder("D60$p1c-$priority", $conveyorpath2.Id, $false)
$obsoleteconnew2 = $vault.DocumentService.AddFolder($obsolete, $conroot2.Id,$false)
...
$chuteroot = $vault.DocumentService.AddFolder($var, $conveyorpath1.Id, $false)
$obsoleteconnew = $vault.DocumentService.AddFolder($obsolete, $chuteroot.Id,$false)
$chuteroot2 = $vault.DocumentService.AddFolder($var, $plantpath.Id, $false)
$obsoleteconnew = $vault.DocumentService.AddFolder($obsolete, $chuteroot2.Id,$false)
...
$conroot = $vault.DocumentService.AddFolder($var, $conveyorpath1.Id, $false)
$obsoleteconnew = $vault.DocumentService.AddFolder($obsolete, $conroot.Id,$false)
...
$plantroot = $vault.DocumentService.AddFolder($var, $conveyorpath1.Id, $false)
$obsoleteconnew = $vault.DocumentService.AddFolder($obsolete, $plantroot.Id,$false)
$plantroot2 = $vault.DocumentService.AddFolder($var2, $plantpath.Id, $false)
$obsoleteconnew = $vault.DocumentService.AddFolder($obsolete, $plantroot2.Id,$false)
