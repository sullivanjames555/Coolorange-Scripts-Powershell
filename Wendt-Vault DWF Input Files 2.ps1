...
$csv = import-csv -Path "C:\Vault Data\Script Input\DWF Input\Dwf Files 2.csv" -Header "File Name"
######### current user for vault session #################################################################
#$Secure2 = Get-Content "C:\Passwords\Encrypted.txt" | ConvertTo-SecureString -Key (1..16)
