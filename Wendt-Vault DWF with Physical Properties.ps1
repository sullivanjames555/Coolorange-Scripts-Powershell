...
$csv = import-csv "C:\Vault Data\Script Input\Physical Properties DWF Input\DWF with Physical.csv" -Header FIle
####
...
$export = Export-Document -Format "DWF" -To $Dwfname -Options $dwfini -OnExport {
       ...
       write-host "Done converting the document ...100%"
         ...
         $savelocation = "\\wal-file.wendtcorp.local\Public\Physical Properties DWF"
...
Clear-Content -path "C:\Vault Data\Script Input\Physical Properties DWF Input\DWF with Physical.csv"